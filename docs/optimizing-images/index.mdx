...
export const ImageCompare = ({children}) => (
  <div
    style={{
      display: 'grid',
...
export const ComparisonImage = ({alt, image, size, dim, pixelated}) => (
	<figure style={{
		display: 'flex',
		...
		<figcaption>{alt + ' (' + size + ')'}</figcaption>
	</figure>
);

export const ComparisonSvg = ({alt, image, size, dim}) => (
	<figure style={{
		display: 'flex',
		flexDirection: 'column', 
		alignItems: 'center'
...
<ImageCompare>
	<ComparisonImage
		...
		size="96KB"
		image={require('./noise-noised.png').default}
	/>
	<ComparisonImage
		alt="Image with contiguous pixels"
		size="3KB"
		image={require('./noise-ordered.png').default}
	/>
</ImageCompare>
...
<ImageCompare>
	<ComparisonImage
		...
		size="5KB"
		image={require('./color-other.png').default}
	/>
	<ComparisonImage
		alt="Black Image"
		size="3KB"
		image={require('./color-black.png').default}
	/>
</ImageCompare>
...
<ImageCompare>
	<ComparisonImage
		alt="Original Image"
		size="425KB"
		image={require('./color-grace-hopper-orig.png').default}
	/>
	<ComparisonImage
		alt="Posterized"
		size="381KB"
		image={require('./color-grace-hopper-posterized.png').default}
	/>
	<ComparisonImage
		alt="Indexed"
		size="142KB"
		image={require('./color-grace-hopper-indexed.png').default}
	/>
</ImageCompare>

### Size

Lastly, the size of the image also a factor. The more pixels there are the bigger the file size will be. Up to now the images have been sized bigger than necessary to demonstrate the effect discussed, but sizing the images to be only as big as necessary will also have a huge impact on file size.
...
<ImageCompare>
	<ComparisonImage
		...
		size="8KB"
		dim="256"
		image={require('./size-1024px.png').default}
	/>
	<ComparisonImage
		alt="256px Image"
		size="6KB"
		dim="256"
		image={require('./size-256px.png').default}
	/>
</ImageCompare>
...
<ImageCompare>
	<ComparisonImage
		...
		size="6KB"
		dim="32"
		image={require('./size-tall.png').default}
	/>
	<ComparisonImage
		alt="Wide Image"
		size="4KB"
		dim="256"
		image={require('./size-wide.png').default}
	/>
</ImageCompare>
...
export const LossySvg = require('./loss-vec.svg').default;
...
<ImageCompare>
	<ComparisonSvg
		...
		size="476 bytes"
		dim="256"
		image={<LossySvg style={{width: '256px', height: '256px'}} />}
	/>
	<ComparisonImage
		...
		dim="256"
		pixelated
		image={require('./loss-lossless.png').default}
	/>
</ImageCompare>
...
Lossy image compression uses visual tricks to discard data that you probably wont notice. When used correctly, this can greatly reduce the file size. These types of compression are limited to specific types of images. If not used correctly, They can result in a poor quality image if used incorrectly.
...
<ImageCompare>
	...
	<ComparisonImage
		...
		dim="256"
		pixelated
		image={require('./loss-lossy.jpeg').default}
	/>
</ImageCompare>
