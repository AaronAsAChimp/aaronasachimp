import {ImageCompare, ComparisonImage, ComparisonSvg} from '../../src/components/ImageCompare/index.jsx';
...
export const PixelRasterSvg = require('./pixel-raster.svg').default;

<ImageCompare>
	<ComparisonSvg
		alt="A pixel in a raster image."
		dim="256"
		image={<PixelRasterSvg style={{width: '256px', height: '256px'}} />}
	/>
</ImageCompare>
...
export const PixelWhereSvg = require('./pixel-where.svg').default;

<ImageCompare>
	<ComparisonSvg
		alt="Pixels, where?"
		dim="256"
		image={<PixelWhereSvg style={{width: '256px', height: '256px'}} />}
	/>
</ImageCompare>
...
export const PixelVectorSvg = require('./pixel-vector.svg').default;

<ImageCompare>
	<ComparisonSvg
		alt="A pixel in a vector image."
		dim="256"
		image={<PixelVectorSvg style={{width: '256px', height: '256px'}} />}
	/>
</ImageCompare>
...
<ImageCompare>
	<ComparisonImage
		...
		dim="256"
		pixelated
		image={require('./rect-1px.png').default}
	/>
	<ComparisonImage
		alt="Rectangle with a 2px black stroke"
		dim="256"
		pixelated
		image={require('./rect-2px.png').default}
	/>
	<ComparisonImage
		alt="Rectangle with a 3px black stroke"
		dim="256"
		pixelated
		image={require('./rect-3px.png').default}
	/>
</ImageCompare>
...
export const RectWithStrokeSvg = require('./rect-with-stroke.svg').default;

<ImageCompare>
	<ComparisonSvg
		alt="Two half pixels"
		dim="256"
		image={<RectWithStrokeSvg style={{width: '256px', height: '256px'}} />}
	/>
</ImageCompare>
...
Our three pixel stroke is rendered as a two pixel stroke plus the half pixel to the left and right. This insight tracks with all even width strokes rendering crisply, while odd numbered strokes always have a blurry edge.

So our solution comes in two parts:

- If the shape has a stroke with an even pixel width, leave it alone.
- If the shape has a stroke with an odd pixel width, shift the shape left and up by a half pixel.

<ImageCompare>
	<ComparisonImage
		alt="The 3px rectangle coming into focus when apply our logic"
		dim="256"
		pixelated
		image={require('./rect-into-focus.webp').default}
	/>
</ImageCompare>
